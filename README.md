...
Play carts in web browser at [pico8.p1x.in](http://pico8.p1x.in).

## Redhood

![gif](http://pico8.p1x.in/gifs/redhood-screen1.gif)

Prototype of a game started at the [Hangover Jam 2017](http://hangoverjam.p1x.in). I added few things (like fog of war) afther the jam. But most of the game and graphics was done in the 1-st of the January.
**Feel free to use the code and made a game of it!**
